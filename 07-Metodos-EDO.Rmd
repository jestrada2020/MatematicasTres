...
```{definition name="Definición de ecuación diferencial"}
...
```{definition name="Ec diferencial separable"}
...
```{example name="Ec Diferencial separable"}
...
```{definition name="Ecuación diferencial lineal"}
...
```{theorem  name="Definición de transformada de Laplace"}
